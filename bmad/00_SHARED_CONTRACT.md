...
TeamName = Literal["AI솔루션팀", "로봇응용기술팀", "미래혁신팀",
                   "배터리기술팀", "전극기술팀"]
Day = Literal["1일차", "2일차", "3일차", "4일차", "5일차"]   # 며칟날 — 달력 날짜가 아니다
Hour = Literal["1타임", "2타임", "3타임", "4타임",   # 자리 번호 — 시각이 아니다
               "5타임", "6타임", "7타임", "8타임"]  # 실제 시각은 회차의 timing 이 정한다
...
- **규칙 1 (SOFT)**: 학사/대학원 날 편중 방지 — 대학원 비율 30% ±20%p
- **규칙 2 (HARD)**: 같은 팀 동시간 중복 금지
- **규칙 3 (SOFT)**: 동일 팀 세로 연속 배치 (Webex 재입장 최소화)
- **규칙 4 (SOFT)**: 첫 타임(1타임)은 소규모 조 우선
